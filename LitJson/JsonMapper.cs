...
namespace LitJson
{
    ...
    internal delegate object ConvertFunc(IJsonWrapper input);
    ...
    public class JsonMapper
    {
        ...
        private static IDictionary<Type, ConvertFunc> custom_object_convert;
        ...
        static JsonMapper ()
        {
            ...
            custom_object_convert = new Dictionary<Type, ConvertFunc>();
